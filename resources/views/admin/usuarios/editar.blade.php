...
@section('subtitulo', 'Modifica los datos de ' . $usuario->nombre)
...
<style>
    ...
    .btn-submit:hover {
        background: #0099d4;
        box-shadow: 0 6px 22px rgba(8,190,255,.32);
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <div class="field-group">
                ...
                <input type="password" id="password" name="password"
                       class="field-input" placeholder="Dejar vacío para no cambiarla">
                <p class="pass-hint">Solo rellena si quieres cambiar la contraseña.</p>
            </div>
        ...
        <div class="grid grid-cols-1 gap-4">
            ...
            <div class="field-group">
                ...
                <textarea id="alergias" name="alergias"
                          class="field-input"
                          placeholder="Indica las alergias del paciente, o deja vacío si no tiene.">{{ old('alergias', $usuario->alergias) }}</textarea>
            </div>
            ...
            <div class="field-group">
                ...
                <textarea id="condiciones_medicas" name="condiciones_medicas"
                          class="field-input"
                          placeholder="Condiciones relevantes para el tratamiento dental.">{{ old('condiciones_medicas', $usuario->condiciones_medicas) }}</textarea>
            </div>
        </div>
